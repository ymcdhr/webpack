...
/******/ 	var hotCurrentHash = "8b1c2d7582184ab9e29d"; // eslint-disable-line no-unused-vars
...
var _coms = __webpack_require__(117);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_coms2['default'], null)
      );
    }
  }]);
...
var _addShoppingCart = __webpack_require__(123);

var _addShoppingCart2 = _interopRequireDefault(_addShoppingCart);

var _filterProducts = __webpack_require__(124);
...
var reducers = (0, _redux.combineReducers)({
    addedList: _addShoppingCart2['default'],
    productList: _filterProducts2['default']
});
...
// 动作：添加到购物车
var addShoppingCart = exports.addShoppingCart = function addShoppingCart(product) {
    return {
...
// 动作：过滤产品，取出type=1的产品
var filterProducts1 = exports.filterProducts1 = function filterProducts1(products) {
    return {
...
// 动作：过滤产品，取出type=1的产品
var filterProducts2 = exports.filterProducts2 = function filterProducts2(products) {
    return {
...
var _navTitle = __webpack_require__(118);
...
// 以下是自定义组件示例
var Coms = function (_Component) {
    _inherits(Coms, _Component);

    function Coms() {
        _classCallCheck(this, Coms);

        return _possibleConstructorReturn(this, (Coms.__proto__ || Object.getPrototypeOf(Coms)).apply(this, arguments));
    }
...
var NavTitlelist = __webpack_require__(119);

var NavTitle = function (_Component) {
    _inherits(NavTitle, _Component);

    function NavTitle(props) {
        _classCallCheck(this, NavTitle);

        var _this = _possibleConstructorReturn(this, (NavTitle.__proto__ || Object.getPrototypeOf(NavTitle)).call(this, props));

        _this.state = { isShowList: false };
        _this.showUlList = _this.showUlList.bind(_this);
        return _this;
    }

    _createClass(NavTitle, [{
        key: 'showUlList',
        value: function showUlList() {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'a',
                        { href: 'javascript:history.back(-1)', className: 'nav-iconbtn' },
                        '\u8FD4\u56DE'
                    )
                ),
                React.createElement(
                    'div',
                    { className: 'nav-title of' },
                    '\u5BFC\u822A\u6807\u9898'
                ),
                React.createElement(
                    'div',
                    { className: 'nav-right tr pr', onClick: function onClick() {
                            return _this2.showUlList();
                        } },
                    React.createElement('img', { className: 'nav-img', src: '//sale.suning.com/images/advertise/cdn/images/more.png' }),
                    React.createElement(NavTitlelist, { showList: this.state.isShowList })
                )
            );
        }
    }]);
...
var NavTitlelist = function (_Component) {
    _inherits(NavTitlelist, _Component);

    function NavTitlelist() {
        _classCallCheck(this, NavTitlelist);

        return _possibleConstructorReturn(this, (NavTitlelist.__proto__ || Object.getPrototypeOf(NavTitlelist)).apply(this, arguments));
    }

    _createClass(NavTitlelist, [{
        key: "render",
        value: function render() {
            ...
            return _react2["default"].createElement(
                "ul",
                { id: "sub-title", className: "nav-more-list" },
                _react2["default"].createElement(
                    "li",
                    null,
                    _react2["default"].createElement(
                        "a",
                        { href: "//m.suning.com", className: "nav-more-icon home-icon" },
                        "\u9996\u9875"
                    )
                ),
                _react2["default"].createElement(
                ...
                _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        "a",
                        { href: "//m.suning.com/list/list.html", className: "nav-more-icon search-icon" },
                        "\u5168\u90E8\u5206\u7C7B"
                    )
                ),
                _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        "a",
                        { href: "//m.suning.com/search.html", className: "nav-more-icon cate-icon" },
                        "\u641C\u7D22"
                    )
                ),
                _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        "a",
                        { href: "//my.suning.com/wap/home.do", className: "nav-more-icon ebuy-icon" },
                        "\u6211\u7684\u6613\u8D2D"
                    )
                )
            );
...
var Products = function Products(_ref) {
    var productList = _ref.productList,
        addedList = _ref.addedList,
        onAddProduct = _ref.onAddProduct,
        onFilter1 = _ref.onFilter1,
        onFilter2 = _ref.onFilter2;
    return _react2["default"].createElement(
        "div",
        ...
        _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                "ul",
                null,
                addedList.map(function (product, index) {
                    return _react2["default"].createElement(
                        "li",
                        { key: index },
                        product.name
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    ...
    return {
        ...
        onFilter1: function onFilter1(list) {
            dispatch(actions.filterProducts1(list));
        },
        onFilter2: function onFilter2(list) {
            dispatch(actions.filterProducts2(list));
        }
    };
};

var ProductsCnt = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_products2['default']);

exports['default'] = ProductsCnt;
module.exports = exports['default'];
 ...
 * redux相关引入
 */
var ReactRedux = __webpack_require__(57);
...
var addedList = function addedList() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var action = arguments[1];

    switch (action.type) {
        case "ADD_SHOPPING_CART":
            return [].concat(_toConsumableArray(state), [action.product]); //类似于object.assign()，直接操作state数据不会立即更新！为何？
...
// state 默认数据
var initList = [{ name: "电脑", type: 1 }, { name: "手机", type: 1 }, { name: "电视", type: 1 }, { name: "汽车", type: 2 }];
...
var productList = function productList() {
    ...
    switch (action.type) {
        case "FILTER_PRODUCTS_1":
            ...
            return initList.filter(function (product) {
...
exports["default"] = productList; //使用export default才能改名
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(34), __webpack_require__(229)(module)))
